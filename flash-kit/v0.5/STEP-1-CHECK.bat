...
setlocal
cd /d "%~dp0"
title S688LN v0.5 - STEP 1 CHECK - read-only, writes NOTHING to the phone
color 0B
echo ==============================================================
echo   STEP 1 - CHECK  v0.5   -- READ-ONLY, writes NOTHING.
...
echo.
echo Packing results into  S688LN-check-v05.zip ...
if exist S688LN-check-v05.zip del S688LN-check-v05.zip
powershell -NoProfile -Command "Compress-Archive -Path check -DestinationPath S688LN-check-v05.zip -Force" >nul 2>&1
if exist S688LN-check-v05.zip goto zip_ok
echo *** Zip step failed - send Viktor the whole "check" folder instead.
goto verdict

:zip_ok
echo Done: S688LN-check-v05.zip
...
echo   That is exactly what v0.5 fixes.

:finish
echo.
echo ==============================================================
echo   DONE - nothing was written to the phone.
echo   1. Send  S688LN-check-v05.zip  to Viktor on Slack.
